import pytest
from solutions.p32_prime_factors import *

implementations = [prime_factors_v1, prime_factors_v2, prime_factors_v3]
ids = ["recursive", "generator/iterative", "changing upper bound"]
