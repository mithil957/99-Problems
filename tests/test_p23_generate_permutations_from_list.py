...
implementations = [generate_permutations_v1, generate_permutations_v2, generate_permutations_v3, generate_permutations_v4]
ids = ["recursive/df", "bfs", "generator", "direct"]
...
def test_generate_permutations(solution):
    ...
    assert set(solution([1, 1, 3, 4, 5, 6], 4)) == set(permutations([1, 1, 3, 4, 5, 6], 4))
